# ============================================================
# MAIN.PY – NumberPanel API (Python port of app (4).js)
# ============================================================
# Deploy on Vercel with:
#   - Python 3.9+
#   - requirements: flask, flask-cors, requests, urllib3
#   - Environment variables: PANEL_BASE_URL, PANEL_USER, PANEL_PASS
# ============================================================
...
def fetch_sesskey(retries=3):
    ...
    for attempt in range(1, retries+1):
        try:
            ...
            headers = {
                **HEADERS,
                "Cookie": session.cookies.get_dict() if session else None,
...
def root():
    return jsonify({
        "message": "NumberPanel API (Python port of app (4).js)",
