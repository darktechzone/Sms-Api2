...
def fetch_otps(limit=100):
    ...
    try:
        ...
        try:
            ...
            add_log(f"OTP response is not JSON – likely HTML (sesskey missing/invalid). Preview: {resp.text[:200]}")
            return []
...
def root():
    return jsonify({
        "message": "NumberPanel API – Full Country Detection",
